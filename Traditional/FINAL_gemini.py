...
X_train_embedded = []
for post_i in tqdm(X_train, desc="Progress"):  # Add progress bar
    X_train_embedded.append(embedding(str(post_i)))
X_test_embedded = []
for post_i in tqdm(X_test, desc="Progress"):  # Add progress bar
    X_test_embedded.append(embedding(str(post_i)))
...
results_df.to_excel("FINAL_Gemini_Embedding.xlsx")
